const starWarsCharacters = [
  ...
  */
  for (const element of obj) {
    ...
    switch (obj.eye_color) {
      ...
      case "bluegray":eyeColor.bluegray.push(obj);break;
      default:
        break;
    }
  }
  ...
  */
  ...
  } else if (crewMass>=900 && crewMass<900){
    console.log("warning: load is over 700")
  }else if (crewMass>=900 && crewMass<1000) {
    console.log("criical load :over 900")
  }else if (crewMass>=1000){
    console.log("danger overload allert")
  }
  /* ESERCIZIO 8
